...
public class GrocerryBill extends javax.swing.JFrame {
 ...
 public void bill_print(){
        ...
        try {
            bill.setText("             Mayur Grocery Store \n");
            bill.setText(bill.getText() + "             23,Arjun Plaza, Chandan Nagar \n");
            bill.setText(bill.getText() + "             kharadi, Pune, \n");
            bill.setText(bill.getText() + "             +91 7058077212, \n");
            bill.setText(bill.getText() + "             Email: Kapadnisms5000@gmail.com \n");
            bill.setText(bill.getText() + "----------------------------------------------------------------\n");
            bill.setText(bill.getText() + " Iteam \tQuantity(kg) \tPrice \n");
            bill.setText(bill.getText() + "----------------------------------------------------------------\n");
            ...
            bill.setText(bill.getText() + "====================================\n");
            bill.setText(bill.getText() +"                     Thanks you, Visit again...!"+"\n");
            bill.setText(bill.getText() + "----------------------------------------------------------------\n");
            ...
            Logger.getLogger(GrocerryBill.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jButton8.setText("Sunflower oil");
        ...
        jButton12.setText("Chilli Powder");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        addTable("Sugar",35.00 );
    }                                        

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
       addTable("Wheat",45.00 );
    }                                        

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        addTable("Rice",190.00 );
    }                                        

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        addTable("Jaggery",55.00 );
    }                                        

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        addTable("Sunflower Oil",230.00 );
    }                                        

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        addTable("Soya Oil",170.00 );
    }                                        

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        addTable("Honey",190.00 );
    }                                        

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
       addTable("Daal",120.00 );
    }                                        

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        addTable("Noodels",85.00 );
    }                                        

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        addTable("Pickel",165.00 );
    }                                         

    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        addTable("Chilli Powder",160.00 );
    }                                         
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GrocerryBill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GrocerryBill().setVisible(true);
            }
        });
    }
